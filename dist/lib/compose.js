 ...
 */
function getEnvVarNames(baseDir) {
 ...
 */
export function generateComposeContent(config, baseDir) {
 ...
 */
export function generateComposeFile(config, paths) {
    ...
    console.log(`  ${chalk.green("OK")} docker-compose.yml generated with ${count} service(s)`);
}
